...
if(world.getBlockName(vx, vy, vz) == "shagecraft:blockIndustrialElectrolyzer"){
	if(world.getTileEntityIntData(vx, vy, vz, "complete") == 1){
		if(world.getTileEntityIntData(vx, vy, vz, "working") == 1){
			player.sendMessage("\u6b63\u5728\u8fdb\u884c" + world.getTileEntityIntData(vx, vy, vz, "recipe") + "\u53f7\u52a0\u5de5\u914d\u65b9\uff0c\u5f53\u524d\u52a0\u5de5\u8fdb\u884c\u4e86 " + world.getTileEntityIntData(vx, vy, vz, "progress")/world.getTileEntityIntData(vx, vy, vz, "maxProgress")*100 + "%\u3002");
