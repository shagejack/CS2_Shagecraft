...
player.sendMessage(world.getTileEntityIntData(vx, vy, vz, "charge") +" RF / " + world.getTileEntityIntData(vx, vy, vz, "maxCharge") + " RF");
}
if(world.getBlockName(vx, vy, vz) == "shagecraft:blockIndustrialElectrolyzer"){
	if(world.getTileEntityIntData(vx, vy, vz, "complete") == 1){
		if(world.getTileEntityIntData(vx, vy, vz, "working") == 1){
			...
			player.sendMessage("\u84c4\u7535\u6c60\uff1a" + world.getTileEntityIntData(vx, vy-4, vz, "charge") + " RF / " + world.getTileEntityIntData(vx, vy-4, vz, "maxCharge") + " RF");
		} else {
